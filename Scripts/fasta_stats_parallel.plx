...
#Script to parse a FASTA file to calculate the number of sequences as well as the sequence min/max/mean/mode lengths
#USAGE $perl fasta_stats_parallel.plx infile.fasta
